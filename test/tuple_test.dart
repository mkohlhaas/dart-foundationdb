      ...
      group('Tuples:', () {
        group('Basic Types:', () {
          ...
          group('Double:', () {
            group('Positive:', () {
              test('5551212.0', () {
                expect(Uint8List.fromList([33, 193, 85, 45, 27, 0, 0, 0, 0]).unpack(), [5551212.0]);
              });
              test('10.0', () {
                expect(Uint8List.fromList([33, 192, 36, 0, 0, 0, 0, 0, 0]).unpack(), [10.0]);
              });
              test('20.0', () {
                expect(Uint8List.fromList([33, 192, 52, 0, 0, 0, 0, 0, 0]).unpack(), [20.0]);
              });
            });
            group('Negative:', () {
              test('-5551212.0', () {
                expect(Uint8List.fromList([33, 62, 170, 210, 228, 255, 255, 255, 255]).unpack(), [-5551212.0]);
              });
              test('-10.0', () {
                expect(Uint8List.fromList([33, 63, 219, 255, 255, 255, 255, 255, 255]).unpack(), [-10.0]);
              });
              test('-20.0', () {
                expect(Uint8List.fromList([33, 63, 203, 255, 255, 255, 255, 255, 255]).unpack(), [-20.0]);
              });
            });
          });
          group('Bool:', () {
